...
export interface Character extends CoreItem {
  ...
  /**
   * A single sentence of description of the character
   * Some words in this sentense should be highlighted to emphrase
...
export interface Word extends CoreItem {
  ...
  /**
   * A single sentence of description of the word
   * Some words in this sentense should be highlighted to emphrase
