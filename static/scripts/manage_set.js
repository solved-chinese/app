...
function updateRadical() {
  let charRadicalsContainer = $(
    `.character-card-container[data-char-id=${selectedCharId}] .radicals-breakdown-container`
  );
...
$(".char").click((e) => {
  ...
  $(`.character-card-container[data-char-id=${selectedCharId}]`)
    .parent()
    .hide();
