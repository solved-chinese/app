    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio', models.FileField(default='error.mp3', upload_to=learning.models.character_path)),
                ('color_coded_image', models.ImageField(default='default.jpg', upload_to=learning.models.character_path)),
                ('stroke_order_image', models.ImageField(default='default.jpg', upload_to=learning.models.character_path)),
                ('mnemonic_explanation', models.CharField(max_length=200)),
                ('mnemonic_1', models.IntegerField(verbose_name='enter number only')),
