$(document).ready(function () {
    ...
    $('#add_new_set_button').click(function () {
        ...
        modal.modal();
        modal > $('.modal-body').load('/accounts/manage_stack_new_set');
    })

    $(document).on('click', 'button[name="add_set_pk"]', function () {
        var form = $('#add_new_set_form');
        var data = form.serialize()+"&add_set_pk="+$(this).val();
        console.log(data)
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#add_new_set_modal'>'.modal-body').load('/accounts/manage_stack_new_set');
            },
